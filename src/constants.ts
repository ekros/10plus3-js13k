...
export const OPERATION_SEQUENCES = {
    ...
    medium: [
        ...
        [OPERATION_TYPE.DIV, OPERATION_TYPE.ADD, OPERATION_TYPE.MUL],
        [OPERATION_TYPE.DIV, OPERATION_TYPE.SUB, OPERATION_TYPE.MUL],
    ...
    hard: [
        ...
        [OPERATION_TYPE.DIV, OPERATION_TYPE.ADD, OPERATION_TYPE.MUL, OPERATION_TYPE.SUB],
        [OPERATION_TYPE.DIV, OPERATION_TYPE.SUB, OPERATION_TYPE.MUL, OPERATION_TYPE.ADD],
