...
export const renderInstructions = () => {
    ...
    drawText("Use the arrow keys to perform the operations in the correct order, to get... that number.", vec2(-0.9, -9.5), 0.5 , COLOR_PALETTE.WHITE, 2, COLOR_PALETTE.TRANSPARENT);
}